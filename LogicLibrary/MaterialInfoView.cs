...
namespace LogicLibrary
{
    public class MaterialInfoView: ITableView, INameIdView
    {
        ...
        //public MaterialInfoView(MaterialInfo info) 
        //{ 
        //    Id = info.Id;
        //    Name = !string.IsNullOrEmpty(info.Name) ? info.Name: info.InnerArt;
        //    InnerArt = info.InnerArt != null ? info.InnerArt : "";

        //    var originalArt = info.ArtInfos.FirstOrDefault(x => x.IsOriginal == true);
        //    if (originalArt != null)
        //    {
        ...
        //        }
        //    }
        //    if (info.ArtInfos != null && info.ArtInfos.Count>0)
        //    {
        //        foreach (var art in info.ArtInfos)
        //        {
        ...
        //public MaterialInfoView(MaterialInfo info, IEnumerable<ArtInfo> arts)
        //{
